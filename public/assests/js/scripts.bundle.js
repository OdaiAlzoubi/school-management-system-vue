...
var KTLayoutAside = (function () {
  ...
  return {
    init: function () {
      ...
      (n = document.querySelector("#kt_aside_menu_wrapper")) &&
        (i = n.querySelector(".menu-link.active")) &&
        !0 !== KTUtil.isVisibleInContainer(i, n) &&
        n.scroll({
          top: KTUtil.getRelativeTopPosition(i, n),
          behavior: "smooth",
        }),
      t && e) &&
        ((r = KTToggle.getInstance(e)).on("kt.toggle.change", function () {
          t.classList.add("animating"),
            setTimeout(function () {
              t.classList.remove("animating");
            }, 300);
        }),
        r.on("kt.toggle.changed", function () {
          var e = new Date(Date.now() + 2592e6);
          KTCookie.set("aside_minimize_state", r.isEnabled() ? "on" : "off", {
            expires: e,
          });
        }));
    },
